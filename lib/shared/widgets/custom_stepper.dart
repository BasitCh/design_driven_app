...
class _CustomStepperState extends State<CustomStepper>
  ...
  Widget _buildVerticalHeader(int index) {
    return Container(
      ...
      decoration: BoxDecoration(
        // color: _isCurrent(index) ? BlackBullColors.gray : BlackBullColors.gray,
        color: BlackBullColors.offWhite,
        borderRadius: _isCurrent(index)
  ...
  Widget _buildVertical() {
    return Container(
      ...
      child: ListView.separated(
        ...
        separatorBuilder: ((BuildContext context, int index) => 10.verticalGap),
      ),
    );
  }
