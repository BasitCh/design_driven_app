...
class NumberInputWithIncrementDecrement extends StatefulWidget {
  ...
  const NumberInputWithIncrementDecrement({
    ...
    this.validator,
    this.style,
    this.incIcon = Icons.keyboard_arrow_up,
    this.decIcon = Icons.keyboard_arrow_down,
    this.fractionDigits = 2,
    this.scaleWidth = 1.0,
    this.scaleHeight = 1.0,
    this.incIconSize,
    this.decIconSize,
    this.decIconColor = BlackBullColors.darkGrey,
    this.incIconColor = BlackBullColors.darkGrey,
    this.onDecrement,
    this.onIncrement,
    this.onSubmitted,
    this.onChanged,
...
class _NumberInputWithIncrementDecrementState
  ...
  void _onSubmitted(String newValue) {
    ...
    if (widget.onSubmitted != null &&
      ...
      widget.onSubmitted!(parsedAndClamped);
    }
  }
